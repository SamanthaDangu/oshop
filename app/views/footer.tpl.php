      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            <h6 class="text-uppercase text-dark mb-3">Type de Produits</h6>
            <ul class="list-unstyled">
              <?php foreach($allTypeForFooter as $type): ?>  
                <li> <a href="<?= $router -> generate('catalog-product-by-type'), $type->getId() ?>" class="text-muted"><?= $type->getName() ?></a></li>
              <?php endforeach; ?>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach ($allBrandForFooter as $brand): ?>
                <li> <a href="<?= $router -> generate('catalog-product-by-brand'), $brand->getId() ?>" class="text-muted"><?= $brand->getName(); ?></a></li>
              <?php endforeach; ?>
            </ul>
          </div>
          <div class="col-lg-4">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-center">
            <p class="mb-md-0"><a class="text-white" href="<?= $router -> generate('mentions-legales')?>">Mentions légales</a><br><a class="text-white" href="<?= $router -> generate('conditions-generales')?>">Conditions générales de vente</a></p>
          </div>

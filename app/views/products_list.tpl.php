  <section class="hero">
    <div class="container">
      ...
      <div class="hero-content pb-5 text-center">
        <h1 class="hero-heading">Détente (id de la route :<?= $viewData['id'] ?>)</h1>
        <div class="row">
      ...
      <!-- product-->
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="py-2">
            ...
            <h3 class="h6 text-uppercase mb-1"><a href="detail.html" class="text-dark"><?= $product->getName() ?></a></h3><span class="text-muted"><?= $product->getPrice() ?>€</span>
          </div>
        </div>
        <!-- /product-->
       <?php endforeach; ?>

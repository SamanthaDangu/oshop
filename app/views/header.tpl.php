      ...
      <div class="container-fluid">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a href="<?= $router -> generate('types')?>" class="nav-link">Types de produit</a>
            </li>
            <li class="nav-item">
              <a href="<?= $router -> generate('brand')?>" class="nav-link">Marques</a>
            </li>
            <li class="nav-item">
              <a href="<?= $router -> generate('blog')?>" class="nav-link">Blog</a>
            </li>
            <li class="nav-item">
              <a href="<?= $router -> generate('contact')?>" class="nav-link">Contact</a>
            </li>
          </ul>
